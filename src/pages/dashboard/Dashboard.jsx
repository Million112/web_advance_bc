     ...
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Tổng tiền bán được</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Xu hướng mua sách tháng này</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Tổng đơn đặt hàng</span>
                </div>
              </div>
            </section>
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Số lượng đơn hàng mỗi tháng</div>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Số lượng xem website (tuần qua)</span>
                </div>
              </div>
              <div className="row-span-3 bg-white shadow rounded-lg">
                <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                  <span>Người dùng theo thứ tự trung bình</span>
                ...
                <div className="overflow-y-auto" style={{maxHeight: '24rem'}}>
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Triệu Quang Hưng</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Hoàng Hải Dương</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Đặng Tuấn Tú</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Chu Văn Oai</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Nguyễn Quang Huy</span>
                      <span className="ml-auto font-semibold">8.2</span>
                    </li>
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                      ...
                      <span className="text-gray-600">Zang Nguyễn (3we)</span>
              ...
              <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Khu vực này đang được phát triển</div>
                <div className="p-4 flex-grow">
