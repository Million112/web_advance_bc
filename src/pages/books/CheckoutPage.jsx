                ...
                <div className="container max-w-screen-lg mx-auto">
                    <div>
                        <div>
                            ...
                            <p className="text-gray-500 mb-2">Tổng thanh toán: ${totalPrice}</p>
                            <p className="text-gray-500 mb-6">Số lượng: {cartItems.length > 0 ? cartItems.length : 0}</p>
                        </div>
                            ...
                            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                                    <div className="text-gray-600">
                                        <p className="font-medium text-lg">Chi tiết người nhận</p>
                                        <p>Vui lòng điền tất cả các trường.</p>
                                    </div>
                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-5 mt-3">
                                                <div className="inline-flex items-center">
                                                    ...
                                                    <label htmlFor="billing_same" className="ml-2 ">Tôi đồng ý với <Link className='underline underline-offset-2 text-blue-600'>Điều khoản & Dịch vụ</Link> và <Link className='underline underline-offset-2 text-blue-600'>Luật mua sắm.</Link></label>
                                                </div>
                                            </div>
